            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    ...
                    <TR>
                        <td>所属客户：</td>
                        <td>
                            <%--似乎取出值可以从属性里取值，不过封装必须要遵守语法--%>
                            <input type="hidden" name="cstCustomerByVisitCustId.custId" style="WIDTH: 180px"
                                   id="cust_id"
                                   value="<s:property value="#saleVisit.cstCustomerByVisitCustId.custId" />"/>
                            <input type="text" style="WIDTH: 180px" id="cust_name"
                                   value="<s:property value="#saleVisit.cstCustomerByVisitCustId.custName" />"/>
                        ...
                        <td>
                            <INPUT class=textbox id="visit_time" type="text"
                                   ...
                                   value="<s:property value="#saleVisit.visitTime" />">
                        </td>
                    </TR>
                    ...
                    <TR>
                        ...
                        <td>
                            <INPUT class=textbox id=sChannel2 type="text"
                                   ...
                                   value="<s:property value="#saleVisit.visitInterviewee" />">
                        </td>
                        <td>拜访地址：</td>
                        <td>
                            <INPUT class=textbox id=sChannel2
                                   style="WIDTH: 180px" maxLength=50 name="visitAddr"
                                   value="<s:property value="#saleVisit.visitAddr" />">
                        </td>
                    </TR>
